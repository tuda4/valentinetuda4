...
export default function Home() {
  ...
  return (
      ...
      <div className="flex gap-10 w-[60%]">
        <button className="mr-auto bg-cyan-500 hover:bg-cyan-700 text-white font-bold py-2 px-4 rounded-full" onMouseOver={prettyPlease} onMouseOut={prettyPlease}>
          <a className="yes" href="/yay">
            Yes
          </a>
        </button>
        <button
